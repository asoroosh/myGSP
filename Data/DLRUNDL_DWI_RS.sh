...
#_________________________________________________________________________________________________
#
# Don't get pro here!! Just leave it as it is!
...
echo "$AWS_ACCESS_KEY and $AWS_SECRET_ACCESS_KEY"
...
--loopcheck --forcedir --network --omatrix1 --nsamples=20 -V 0 --dir=${Where2}/DWINetwork
