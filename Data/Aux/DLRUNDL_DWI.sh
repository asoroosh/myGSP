...
AWS_ACCESS_KEY="AKIAIK5NOLSP4DS4AMYA"
AWS_SECRET_KEY="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"
...
s3get hcp-openaccess-temp/HCP_1200/${SubID}/T1w/T1w_acpc_dc_restore_1.25.nii.gz ${Where2Tmp}/T1w_acpc_dc_restore_1.25.nii.gz
s3get hcp-openaccess-temp/HCP_1200/${SubID}/MNINonLinear/xfms/acpc_dc2standard.nii.gz ${Where2Tmp}/xfms/acpc_dc2standard.nii.gz
s3get hcp-openaccess-temp/HCP_1200/${SubID}/MNINonLinear/xfms/standard2acpc_dc.nii.gz ${Where2Tmp}/xfms/standard2acpc_dc.nii.gz
...
--nsamples=20 \
-V 1 \
--dir=${Where2}/DWINetwork \
--invxfm=${Where2Tmp}/xfms/acpc_dc2standard \
--xfm=${Where2Tmp}/xfms/standard2acpc_dc \
--seedref=${Where2Tmp}/T1w_acpc_dc_restore_1.25.nii.gz \
